...
docker run -v /eodata:/eodata -it --rm --name "jupytepide" --link geoserver9421:geoserver -p 8888:8888 jupytepide/eodata-notebook:latest start-notebook.sh --NotebookApp.token=''